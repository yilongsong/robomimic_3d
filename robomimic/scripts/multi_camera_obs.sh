...
python multi_camera_dataset_to_obs.py --dataset /users/nharlalk/data/shared/mimicgen/core/pick_place_d0.hdf5 --env_xml /users/nharlalk/data/nharlalk/robosuite/robosuite/models/assets/arenas/table_arena.xml --num_cameras 5 --output_file multicamera_pick_place_d0_5.hdf5
