...
DEPTH_MINMAX = {'birdview_depth': [1.180, 2.480],
                ...
                'squared0view3_depth': [0.6, 1.6],
                'squared0view4_depth': [0.6, 1.6],
                'squared0viewfar_depth': [0.9, 2.4],
                'squared0view2far_depth': [0.9, 2.4],
                'squared0view3far_depth': [0.9, 2.4],
                'squared0view4far_depth': [0.9, 2.4],
